...
import { Award, Compass, CheckCircle2, ArrowUpRight, History } from "lucide-react";

// Imported directly from the JSON file generated by backend/update_readme_benchmarks.py.
// GitHub Actions regenerates this file after every race weekend — no manual edits needed.
...
export function ModelTrackRecordCard() {
  ...
  // "Avg. X/3 podium spots" — how many the model gets right per race on average
      ...
      <div className="border-b border-hairline">
        <div className="border-b border-hairline p-3.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider text-muted-foreground">
              ...
              <span>Podium Spots Identified</span>
            </div>
            <span className="tabular text-xs font-semibold text-muted-foreground">{podiumPct}%</span>
          </div>
          <p className="tabular mt-1 text-2xl font-black tracking-tight text-foreground">
            {podiumHits} / {totalPodiumSlots}
          </p>
          <p className="text-[10px] text-muted-foreground/80">Avg. {avgLabel}</p>
        </div>
        ...
        <div className="grid grid-cols-2 divide-x divide-hairline">
          <div className="p-3.5">
            ...
            <p className="tabular mt-1 text-xl font-black tracking-tight text-foreground">{top10Pct}%</p>
          ...
          <div className="p-3.5">
            ...
            <p className="tabular mt-1 text-xl font-black tracking-tight text-foreground">{modelBrier}</p>
            <p className="text-[10px] text-muted-foreground/80">Probability calibration</p>
          </div>
        </div>
      </div>
